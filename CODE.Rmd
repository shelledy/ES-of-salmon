...
hFWC <- ggplot() + 
  ...
  geom_bar(data = h.CICES, aes(x=CICES_section, y=n, color = "Hatchery"), width = 1, linewidth = 1.5, alpha = 0.01, stat = "identity") + scale_color_manual(values = c(Hatchery = "red")) + ylab("# occurrences") + xlab("CICES section")
...
hFWE <- ggplot() + 
  ...
  geom_bar(data = h.EE, aes(x=EE_domain, y=n), width = 1, linewidth = 1.5, alpha = 0.01, color = "red", stat = "identity") + ylab("# occurrences") + xlab("EEScF domain")
```
